...
public class SettingsController implements Initializable {
	...
	private void handleDatabaseExportAction(ActionEvent event) {
		...
		if (selectedDirectory == null) {
			...
			DatabaseExporter databaseExporter = GlobalProperty.applicationContext.getBean(DatabaseExporter.class);
			databaseExporter.setBackupDirectory(selectedDirectory);
