package com.mr.rpa.assistant.ui.listmember;
...
import com.mr.rpa.assistant.ui.addmember.MemberAddController;
...
public class MemberListController implements Initializable {
    ...
    private void handleMemberEdit(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("assistant/ui/addmember/member_add.fxml"));
